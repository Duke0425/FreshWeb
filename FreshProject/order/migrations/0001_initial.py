# Generated by Django 2.1.4 on 2019-01-14 02:56
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('pay_status', models.CharField(choices=[('TRADE_FINISHED', '交易结束'), ('TRADE_CLOSE', '交易关闭'), ('paying', '待支付'), ('WAIT_BUYER_PAY', '交易创建'), ('TRADE_SUCCESS', '成功')], default='paying', max_length=20, verbose_name='交易状态')),
